#!/usr/bin/env python3
"""
Resume Information Extractor using Few-Shot Learning with Ollama LLM

This script extracts structured information (name, years of experience, and degrees)
from resume files (PDF and DOCX) using few-shot learning with Ollama's local LLMs.

Usage:
    python main.py --file path/to/resume.pdf
    python main.py --directory path/to/resumes/folder
    python main.py --file path/to/resume.pdf --model llama3:70b
    python main.py --directory path/to/resumes/folder --output results.json

Requirements:
    - Ollama installed and running (https://ollama.ai)
    - Required Python packages: requests, pdfplumber, python-docx
"""
